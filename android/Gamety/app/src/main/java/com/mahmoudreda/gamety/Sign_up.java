...
public class Sign_up extends Activity {
    ...
    Button l;
    String first_name, second_name, last_name, id_sign_up, email_sign_up, password_sign_up;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                second_name = y.getText().toString();
                ...
                editor.commit();
                if (first_name.length() >= 1 || second_name.length() >= 1 || last_name.length() >= 1 || id_sign_up.length() >= 1 || email_sign_up.length() >= 1 || password_sign_up.length() >= 1) {
                    if (id_sign_up.length() == 9) {
